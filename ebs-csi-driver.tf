# Using gp3, we multiple pods can't write to the same file
...
# Optional: only if you want to encrypt the EBS drives
# In order to encrypt, parameter must be set when creating the storage class
# and a KMS mey ID must be passed
